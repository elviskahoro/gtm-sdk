...
def test_person_add_query_rejects_extra_fields() -> None:
...
def test_person_add_query_has_no_api_key_field() -> None:
    q = PersonAddQuery(email="a@b.com")
    assert not hasattr(q, "attio_api_key")


def test_person_search_query_accepts_valid_fields() -> None:
