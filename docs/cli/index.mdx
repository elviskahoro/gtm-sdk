---
title: "gtm CLI overview and command groups"
description: "Overview of the gtm command line: invocation via uv, command groups for Attio, Apollo, Exa, Parallel, and more, plus shared JSON output conventions."
---
