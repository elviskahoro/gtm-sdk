...
| `/mcp` | A hosted [MCP](https://modelcontextprotocol.io/) server exposing search and docs-query tools over this site. Point your MCP client at this site's `/mcp` endpoint. |
