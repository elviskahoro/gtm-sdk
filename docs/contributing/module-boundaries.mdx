...
description: "Enforce architectural rules with tach: no cross-lib imports, no orchestration in libs/, CLI has no business logic. Run tach check locally and in CI."
---
