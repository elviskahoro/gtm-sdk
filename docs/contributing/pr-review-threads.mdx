...
description: "Inspect and selectively resolve GitHub PR review threads with scripts/pr-review-threads.py, run in the repo's pinned Flox environment with an opt-in Dagger container."
---
