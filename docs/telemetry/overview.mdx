...
description: "How the gtm-sdk OpenTelemetry pipeline fans traces and logs out over Modal RPC to Dash0, HyperDX, Logfire, and Grafana, with a direct single-sink fallback."
---
